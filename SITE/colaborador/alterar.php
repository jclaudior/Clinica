<html lang="pt-br">	
	<head>
		<title>Altera��o de Colaborador</title>
	</head>
	
	<body>
		<center>

		<h2>Altera��o de Colaborador</h2>
		...
		<?php
			...
			if ($linhas<1) {
				// N�o encontrou
				die("Time id: $codigo n�o existe mais");
			}
			// Criar $dados que e um vetor/matriz da 1� linha
		...
		<input type="hidden" name="id" value="<?php echo $codigo; ?>">
			...
			<fieldset>
				...
				<table border="1">
					...
					<tr>
						<th colspan="8">Observa��es</th>
					</tr>
					<tr>
						<td colspan="8"><textarea name="obsColaborador" rows="10" cols="83" placeholder="Informa��es complementares"><?php echo $obsCola; ?></textarea></td>
					</tr>
				</table>
			</fieldset>
			<fieldset>
					...
					<table border="1">
						...
						<tr>
							...
							<td><center>
								...
								<input type="radio" name="descVTColaborador" value="0" <?php echo $checkdVtColaN;?>>N�o</center>
							</td>
							<th>Descontar VR/VA:</th>
							<td><center>
								<input type="radio" name="descVRColaborador" value="1" <?php echo $checkdVrColaS;?>>Sim
								<input type="radio" name="descVRColaborador" value="0" <?php echo $checkdVrColaN;?>>N�o</center>
							</td>
						</tr>
					</table><br>
			</fieldset><br>
