<html lang="pt-br">	
	...
	<body>
		...
		<h2 class="display-3">Alteração de Colaborador</h2>
		...
		<?php
			...
			// Criar $dados que e um vetor/matriz da 1º linha
		...
		<input type="hidden" name="id" value="<?php echo $codigo; ?>">
			...
			<fieldset>
				<legend><h2 class="display-4">Dados Pessoais</h2></legend>
				<table border="0" class="table">
					...
					<tr>
						<td><input  class="form-control" type="text" name="nomeColaborador" maxlength="30" size="16" placeholder="Insira o Nome" required value="<?php echo $nomeCola; ?>"></td>
						<td><input  class="form-control" type="text" name="rgColaborador" maxlength="12" size="16" placeholder="Insira o RG" required value="<?php echo $rgCola; ?>"></td>
						<td><input  class="form-control" type="text" name="cpfColaborador" maxlength="14" size="16" placeholder="Insira o CPF" required value="<?php echo $cpfCola; ?>"></td>
						<td><input  class="form-control" type="text" name="especialidadeColaborador" maxlength="20" size="16" placeholder="Especialidade" required value="<?php echo $espCola; ?>"></td>
					</tr>
					<tr>
						<th colspan="8">Observações</th>
					</tr>
					<tr>
						<td colspan="8"><textarea class="form-control" name="obsColaborador" rows="10" cols="83" placeholder="Informações complementares"><?php echo $obsCola; ?></textarea></td>
					</tr>
				</table>
			</fieldset>
			<fieldset>
				<legend><h2 class="display-4">Dados Para Cadastro</h2></legend>
					<table border="0" class="table">
						<tr>
							<th>Data Admissão:</th>
							<td><input class="form-control" type="date" name="dataAdmiColaborador" value="<?php echo $admiCola; ?>"></td>
							<th>Data Demissão:</th>
							<td><input class="form-control" type="date" name="dataDemiColaborador" value="<?php echo $demiCola; ?>"></td>
						</tr>
						<tr>
							<th>Departamento:</th>
							<td><input class="form-control" type="text" name="departamentoColaborador" maxlength="30" size="16" placeholder="Insira o Departamento" value="<?php echo $depCola; ?>"></td>
							<th>Sala:</th>
							<td><input class="form-control" type="text" name="salaColaborador" maxlength="4" size="16" placeholder="Insira a Sala" value="<?php echo $salaCola; ?>"></td>
						</tr>
						<?php 
							$checkIndeter ="";
							$checkDetermi ="";
						...
						<tr>
							...
							<th>Valor:</th>
							<td>
								<input class="form-control" type="text" name="valorColaborador" maxlength="10" size="16" placeholder="Insira o Valor" required value="<?php echo $valorCola; ?>">
							</td>
						</tr>
						<?php 
							$checkdVtColaS ="";
			...
			<fieldset>
					...
					<table border="0" class="table">
						...
						<tr>
							<th>Horário</th>
								<td><input class="form-control" type="time" name="tabEntra" maxlength="4" size="16" value="<?php echo $entCola; ?>"></td>
								<td><input class="form-control" type="time" name="tabSai" maxlength="4" size="16" value="<?php echo $saiCola; ?>"></td>
							<td>
								<?php
									if ($dsDomCola=="Dom")
